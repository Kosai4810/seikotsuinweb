...
const sections = [
  ...
  { title: "98,000円からの制作内容", text: "先着3院限定のモニター制作プランでは、開院直後や既存サイトの見直しに必要な基本機能をまとめて提供します。制作事例への掲載や公開後の感想にご協力いただける院が対象です。", items: ["5ページ程度のサイト制作", "スマートフォン対応", "問い合わせフォーム", "メール・電話導線", "Googleマップ導線", "基本SEO設定", "修正2回", "公開後1か月サポート"] },
