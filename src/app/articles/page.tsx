...
export const metadata: Metadata = { title: "整骨院の開業・ホームページ制作に役立つ読みもの", description: "整骨院・接骨院の開業準備、ホームページ制作の費用や必要な掲載内容を、具体的に分かりやすく解説します。", alternates: { canonical: "/articles" } };
