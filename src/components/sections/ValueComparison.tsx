...
export function ValueComparison() {
  return <section className="py-14 md:py-18 bg-[#eee8dc]">
    <div className="max-w-7xl mx-auto px-6 lg:px-12">
      ...
      <div className="mt-6 border border-[#a88750] bg-[#f7f2e8] px-5 py-5 text-center"><p className="mb-1 text-xs tracking-wide text-[var(--nibi)]">通常 <span className="line-through decoration-[#a88750] decoration-2">128,000円（税込）〜</span></p><p className="font-serif text-lg md:text-2xl tracking-wide">これらを含んで、<span className="block sm:inline text-[#806334] mt-2 sm:mt-0"><strong className="text-2xl md:text-4xl font-medium">先着<span className="mx-1 inline-block font-serif text-4xl md:text-6xl leading-none tracking-tight">3</span>院限定 98,000円</strong>（税込）〜</span></p></div>
    </div>
  </section>;
}
